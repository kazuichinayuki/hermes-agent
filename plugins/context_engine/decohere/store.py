...
Every raw message is persisted durably in SQLite. Turn LedgerStore are stored
...
class LedgerStore:
    ...
    Stores complete turn LedgerStore as JSON blobs. Indexes concepts_and_definitions
